      ...
      <div ref={ref} className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-20">
          <div className="lg:w-1/2">
            ...
            <div className={`animate-in animate-in-delay-1 ${isVisible ? 'visible' : ''} mt-8`}>
              <p
                className="text-2xl md:text-3xl lg:text-4xl font-heading font-light leading-relaxed"
            ...
            <div className={`animate-in animate-in-delay-3 ${isVisible ? 'visible' : ''} mt-8 flex items-center gap-3`}>
              <span
          ...
          <div className="lg:w-1/2">
            ...
            <div className={`animate-in animate-in-delay-3 ${isVisible ? 'visible' : ''} mt-4`}>
              <p
                className="text-xs"
